              ...
              <hr>
                <div class="product-buttons-wrap clearfix">
                    <div class="product-qyt-action quantity-adder pull-left">
                        ...
                        <button type="button" id="button-cart" data-loading-text="<?php echo $text_loading; ?>" class="pull-left btn"><?php echo $button_cart; ?></button>
                    </div>
                    <input type="hidden" name="product_id" value="<?php echo $product_id; ?>" />                    
                    <div class="clearfix"></div>
                    <hr>
                    <div class="action">
                        <button class="compare" type="button" data-toggle="tooltip" title="<?php echo $button_compare; ?>" onclick="compare.add('<?php echo $product_id; ?>;');"><i class="fa fa-refresh"></i><?php echo $button_compare; ?></button>
                        <button class="wishlist" type="button" data-toggle="tooltip" title="<?php echo $button_wishlist; ?>" onclick="wishlist.add('<?php echo $product_id; ?>;');"><i class="fa fa-heart-o"></i><?php echo $button_wishlist; ?></button>
                    </div>
                </div>
