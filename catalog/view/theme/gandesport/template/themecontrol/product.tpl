    ...
    <div id="content" class="<?php echo $class; ?>">
      ...
      <div class="product-info">
        ...
        <div class="row">
          ...
          <?php require( ThemeControlHelper::getLayoutPath( 'product/preview/default_quickview.tpl' ) );  ?>
            ...
            <div id="product">
              ...
              <div class="product-buttons-wrap clearfix">
                    ...
                    <div class="action">
                        ...
                        <button class="compare" type="button" title="<?php echo $button_compare; ?>" onclick="compare.add('<?php echo $product_id; ?>;');"><i class="fa fa-refresh"></i></button>
                        <button class="wishlist" type="button" title="<?php echo $button_wishlist; ?>" onclick="wishlist.add('<?php echo $product_id; ?>;');"><i class="fa fa-heart-o"></i></button>
                    </div>
                </div>
