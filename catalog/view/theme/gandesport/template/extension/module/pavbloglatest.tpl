					...
					<div class="latest-posts-image pull-left">
				  	...
				  	<div class="latest-posts-meta media-body">
                        ...
                        <div class="latest-posts-profile">
								...
								<!-- <span class="comment"><?php echo $objlang->get("text_comment_count");?><?php echo $blog['comment_count'];?></span> -->
								 <span class="comment"><span class="commentv2"><?php echo $objlang->get("text_comment_count");?></span><?php echo $blog['comment_count'];?></span>
						</div>
