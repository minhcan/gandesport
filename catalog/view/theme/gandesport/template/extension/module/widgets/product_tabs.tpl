...
<div class="product-tabs panel <?php echo $addition_cls; ?>">
	<div class="container">
		...
		<?php } ?>
		<div class="tab-heading pull-left">
	 ...
	 <div class="tab-content ">
		<?php foreach( $tabs as $tab => $products ) {
			...
			?>
				...
				<a class="carousel-control left" href="#tab-<?php echo $tab.$id;?>"   data-slide="prev"><i class="fa fa-chevron-left" aria-hidden="true"></i></a>
				<a class="carousel-control right" href="#tab-<?php echo $tab.$id;?>"  data-slide="next"><i class="fa fa-chevron-right" aria-hidden="true"></i></a>
				</div>
				<?php } ?>
