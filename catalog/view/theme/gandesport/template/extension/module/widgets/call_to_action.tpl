<div class="call-to-action <?php echo $style;?> <?php echo $addition_cls; ?>">
    <div class="call-to-action-inner">
    	<?php if(isset($widget_heading)&&!empty($widget_heading)) {?>
		<div class="widget_heading <?php if($style == 'call-to-action-v2'){ echo "heading-v9"; }elseif($style == 'call-to-action-v4 light-style'){ echo "heading-v3 heading-light";}elseif($style == ''){ echo "";} ?>">
			...
			<?php } ?>
            <?php if( $show_title ) { ?>
                <h1 class="widget_title"><?php echo $widget_heading;?></h1>
