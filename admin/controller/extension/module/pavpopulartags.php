...
class ControllerExtensionModulePavpopulartags extends Controller {
	...
	public function index() {
		...
		if( isset($this->request->get['module_id']) && isset($this->request->get['delete']) ){
			...
			$this->response->redirect($this->url->link('extension/module/pavpopulartags', 'token=' . $this->session->data['token'], 'SSL'));
		}
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			if( isset($this->request->get['module_id']) ) {
				$this->response->redirect($this->url->link('extension/module/pavpopulartags', 'module_id='.$this->request->get['module_id'].'&token=' . $this->session->data['token'], 'SSL'));
			}else{
		...
		$this->data['action'] = $this->url->link('extension/module/pavpopulartags', 'token=' . $this->session->data['token'], 'SSL');
		...
		if (isset($this->request->get['module_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
			...
			$this->data['action'] = $this->url->link('extension/module/pavpopulartags', 'module_id='.$this->request->get['module_id'].'&token=' . $this->session->data['token'], 'SSL');
		}else {
			$module_info = $default;
		...
		$moduletabs = $this->model_extension_module->getModulesByCode( 'pavpopulartags' );
	 	$this->data['link'] = $this->url->link('extension/module/pavpopulartags', 'token=' . $this->session->data['token'] . '', 'SSL');
		...
		$this->response->setOutput($this->load->view('extension/module/pavpopulartags.tpl', $this->data));
	}
	...
	public function _getBreadcrumbs(){
		...
		$this->data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('extension/module/pavpopulartags', 'token=' . $this->session->data['token'], 'SSL'),
			'separator' => ' :: '
		);
	}
